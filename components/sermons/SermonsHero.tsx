...
export function SermonsHero() {
  ...
  return (
    ...
    >
      ...
      >
        <OptimizedImage
          src="https://images.unsplash.com/photo-1616442830389-0fe0305dd61e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
      ...
      <div className="text-center z-20 px-6 max-w-4xl" style={{ opacity: opacityValue }}>
        ...
        <RevealText className="text-xl md:text-2xl max-w-2xl mx-auto mb-12 text-gray-200" delay={0.4}>
          Explore our collection of inspiring messages that will strengthen your faith and deepen your understanding of
          God's Word.
        </RevealText>
